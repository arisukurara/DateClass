...
int main()
{
    ...
    cout << "Creating date object with parameters, set to Oct 29 2003:" << endl;
    ...
    cout << "Testing the set date function, set to Jun 21 2012:" << endl;
    ...
    --defaultDate;
    cout << "Testing decrementing:" << endl;
    ...
    cout << "Testing year changes: " << endl;
    cout << endl << "USING POSTFIX" << endl;
